                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="{{ route('roles.show', $role) }}" class="btn btn-sm btn-view" title="View"><i class="bi bi-eye"></i></a>
                                <a href="{{ route('roles.edit', $role) }}" class="btn btn-sm btn-edit" title="Edit"><i class="bi bi-pencil"></i></a>
                    ...
                    <tr>
                        <td colspan="5" class="empty-state">
                            ...
                            <div class="empty-state-text">Start by adding a new role to the system</div>
                            <a href="{{ route('roles.create') }}" class="btn btn-add">
                                <i class="bi bi-plus-circle"></i> Add New Role
                            </a>
                        </td>
